...
export const INTEGRATION_ROUTES: Routes = [
  ...
  {path: 'snomed/management', component: SnomedManagementComponent, data: {privilege: ['snomed-ct.CodeSystem.read']}},
  {path: 'snomed/branches/add', component: SnomedBranchEditComponent, data: {privilege: ['snomed-ct.CodeSystem.write']}},
