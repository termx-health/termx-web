...
export const CODE_SYSTEM_ROUTES: Routes = [
  ...
  {path: ':id/concepts/:concept/versions/:conceptVersion/designations/add', component: CodeSystemDesignationEditComponent},
  {path: ':id/concepts/:concept/versions/:conceptVersion/designations/:designation/edit', component: CodeSystemDesignationEditComponent},
