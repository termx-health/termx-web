...
export class ResourceReleaseModalComponent implements OnInit {
  ...
  public constructor(private releaseService: ReleaseService, private translateService: TranslateService, private router: Router, private authService: AuthService) {}
