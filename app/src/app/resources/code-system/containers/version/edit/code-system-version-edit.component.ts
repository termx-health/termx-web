...
import { MuiFormModule, MuiSpinnerModule, MuiCardModule, MuiInputModule, MuiDatePickerModule, MuiMultiLanguageInputModule, MuiButtonModule, MuiIconModule } from '@termx-health/ui';
...
export class CodeSystemVersionEditComponent implements OnInit {
  ...
  public ngOnInit(): void {
    ...
    if (isDefined(versionCode)) {
      this.mode = 'edit';
      this.canEdit = this.authService.hasPrivilege(this.codeSystemId + '.CodeSystem.write');
