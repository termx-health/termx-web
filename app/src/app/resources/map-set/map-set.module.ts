...
export const MAP_SET_ROUTES: Routes = [
  ...
  {path: 'add', component: MapSetEditComponent, data: {privilege: ['*.MapSet.write']}},
  {path: ':id/edit', component: MapSetEditComponent, data: {privilege: ['{id}.MapSet.write']}},
  {path: ':id/details', component: MapSetEditComponent, data: {privilege: ['{id}.MapSet.read']}},
  {path: ':id/summary', component: MapSetSummaryComponent, data: {privilege: ['{id}.MapSet.read']}},
  {path: ':id/provenances', component: MapSetProvenancesComponent, data: {privilege: ['{id}.MapSet.read']}},

  {path: ':id/versions/add', component: MapSetVersionEditComponent, data: {privilege: ['{id}.MapSet.write']}},
  {path: ':id/versions/:versionCode/summary', component: MapSetVersionSummaryComponent, data: {privilege: ['{id}.MapSet.read']}},
  {path: ':id/versions/:versionCode/provenances', component: MapSetProvenancesComponent, data: {privilege: ['{id}.MapSet.read']}},
  {path: ':id/versions/:versionCode/details', component: MapSetVersionEditComponent, data: {privilege: ['{id}.MapSet.read']}},
  {path: ':id/versions/:versionCode/edit', component: MapSetVersionEditComponent, data: {privilege: ['{id}.MapSet.write']}},
